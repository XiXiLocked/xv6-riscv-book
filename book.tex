...
%引入中文宏包，并保持原书西式排版标签 (如 Chapter 1, Contents)
\usepackage[UTF8, scheme=plain]{ctex}

% ==================== 字体精准配置 (针对 xelatex) ====================
% ==================== 字体精准配置 (针对 xelatex) ====================
% 1. 配置中文正文与粗体（根据你的 ls 结果，实际为 .ttf 格式）
\setCJKmainfont[
    Path = font/,
    Extension = .ttf,
...
% 2. 配置英文正文与粗体（原版自带的 MinionPro 家族，实际为 .otf 格式）
\setmainfont[
    Path = font/,
    Extension = .otf,
...
% 3. 配置全书等宽代码字体（JetBrains Mono，实际为 .ttf 格式）
\setmonofont[
    Path = font/,
    Extension = .ttf,
